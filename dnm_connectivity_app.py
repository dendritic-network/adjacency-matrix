...
def create_dnm_connectivity(model_type, num_inputs, num_outputs, sparsity, num_dendrites,
    ...
    args = SimpleNamespace(M=num_dendrites, M_dist=dendrite_dist, degree_dist=degree_dist,
        ...
        degree_std=2.0, M_std=num_dendrites/20, gamma_std=0.05, synaptic_std=0.1,
...
model_type = st.sidebar.radio("Layer Border Wiring Pattern", ["Wrap-around", "Bounded"], help="**Local**: Boundary-aware, non-wrapping connections. **Original**: Modulo-wrapping connections.")
